...
import com.pacs.molecoms.mysql.entity.Session;
...
//    Optional<User> findByEmail(String email);//    Optional<User> findByEmailAndProvider(String email, String provider); // ✅ 추가됨
